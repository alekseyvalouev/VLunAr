...
def train_strafe_left(
    ...
    for ep in range(1, episodes + 1):
        ...
        for t in range(max_steps):
            ...
            # Example strafe-left shaping (optional):
            # state[0] is horizontal position; encourage being left of center.
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Train a DQN agent for the strafe-left task."
    )
