...
def run_strafe_left_agent(
    checkpoint_path: str,
    video_folder: str = "videos/strafe_left",
    episodes: int = 1,
    max_steps: int = 1000,
    init_x_frac: float = 0.5,
    init_y_frac: float = 0.5,
    random_initial_force: bool = False,
    actions_folder: str = "actions/strafe_left",
):
...
def main():
    parser = argparse.ArgumentParser(description="Test STRAFE LEFT agent")
    parser.add_argument(
        "--checkpoint",
        type=str,
        default="checkpoints/strafe_left/best.pt",
    )
    parser.add_argument(
        "--video-folder",
        type=str,
        default="videos/strafe_left",
    )
    parser.add_argument(
        "--episodes",
        type=int,
    ...
    run_strafe_left_agent(
        ...
        actions_folder="actions/strafe_left",
    )
